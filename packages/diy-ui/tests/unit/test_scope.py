...
class TestScopeNodeTree:
    ...
    def test_nesting_three_levels(self):
        root = diyui.ScopeNode()
        mid = diyui.ScopeNode()
        leaf = diyui.ScopeNode()
        root._add_child(mid)
        mid._add_child(leaf)
...
class TestScopeConfigLookup:
    ...
    def test_deep_chain_fallback(self):
        ...
        root._add_child(mid)
        mid._add_child(leaf)
        assert leaf._lookup_mode == diyui.ScopeMode.PROD
        assert mid._lookup_mode == diyui.ScopeMode.DEV
