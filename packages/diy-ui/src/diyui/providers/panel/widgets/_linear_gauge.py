"""Panel LinearGauge — pn.widgets.LinearGauge 的 diyui 包装。"""
...
class LinearGauge(UIComponent, pn.widgets.LinearGauge):
    ...
    def __init__(
        ...
        *,
        ...
        self.diy.signal: diyui.Signal[float] = diyui.Signal[float](value)
        _label = label or name
        self.diy.init_done: bool = False
        pn.widgets.LinearGauge.__init__(
            self,
            label=_label,
            value=value,
            align=align,
