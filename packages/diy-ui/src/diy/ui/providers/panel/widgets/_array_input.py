"""Panel ArrayInput — pn.widgets.ArrayInput 的 diy.ui 包装。"""
...
class ArrayInput(UIComponent, pn.widgets.ArrayInput):
    ...
    def __init__(
        ...
        *,
        ...
        self.diy.signal: diy.ui.Signal[list[Any]] = diy.ui.Signal[list[Any]](value)
        _label = label or name
        self.diy.init_done: bool = False
        pn.widgets.ArrayInput.__init__(
            self,
            label=_label,
            value=value,
            align=align,
