"""Panel DatetimeRangePicker — pn.widgets.DatetimeRangePicker 的 diy.ui 包装。"""
...
class DatetimeRangePicker(UIComponent, pn.widgets.DatetimeRangePicker):
    ...
    def __init__(
        ...
        *,
        ...
        pn.widgets.DatetimeRangePicker.__init__(
            self,
            label=_label,
            value=value,
            align=align,
