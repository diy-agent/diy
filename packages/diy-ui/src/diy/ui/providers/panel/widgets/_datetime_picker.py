"""Panel DatetimePicker — pn.widgets.DatetimePicker 的 diy.ui 包装。"""
...
class DatetimePicker(UIComponent, pn.widgets.DatetimePicker):
    ...
    def __init__(
        ...
        *,
        ...
        pn.widgets.DatetimePicker.__init__(
            self,
            label=_label,
            value=value,
            align=align,
