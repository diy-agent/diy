...
class TestScopeConfigLookup:
    ...
    def test_deep_chain_fallback(self):
        ...
        root._add_child(mid)
        mid._add_child(leaf)
        assert leaf.mode == diyui.ScopeMode.PROD
        assert mid.mode == diyui.ScopeMode.DEV
