...
class CheckButtonGroup(UIComponent, pn.widgets.CheckButtonGroup):
    ...
    def __init__(
        ...
        *,
        ...
        self.diy.signal: diyui.Signal[list[Any]] = diyui.Signal(value or [])
        self.diy.init_done: bool = False
        pn.widgets.CheckButtonGroup.__init__(
            self,
            label=_label,
            value=value or [],
            align=align,
