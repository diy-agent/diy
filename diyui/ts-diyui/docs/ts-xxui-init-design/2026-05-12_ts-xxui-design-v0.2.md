...
```typescript
// pi-tui 框架
import { App } from "diyui/providers/pi-tui";
...
```typescript
import { App, ScopeConfig, ImmediateScheduler } from "diyui/providers/pi-tui";
...
```typescript
import { App, ImmediateScheduler } from "diyui/providers/pi-tui";
...
| App 入口 | 框架特定：`import { App } from "diyui/providers/pi-tui"` |
