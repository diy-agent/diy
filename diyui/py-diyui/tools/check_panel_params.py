"""检查 diyui Panel 包装器与原生 Panel 组件的参数一致性。
...
app = cyclopts.App(
    ...
    help="检查 diyui Panel 包装器与原生 Panel 组件的参数一致性。",
    version="0.1.0",
)
...
def list_classes() -> None:
    """列出所有已注册的 diyui wrapper 和可查询的 Panel 类名。"""
    _list_mode()
