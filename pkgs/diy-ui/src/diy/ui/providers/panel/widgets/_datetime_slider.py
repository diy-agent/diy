"""Panel DatetimeSlider — pn.widgets.DatetimeSlider 的 diy.ui 包装。"""
...
class DatetimeSlider(UIComponent, pn.widgets.DatetimeSlider):
    ...
    def __init__(
        ...
        *,
        ...
        pn.widgets.DatetimeSlider.__init__(
            self,
            label=_label,
            value=value,
            align=align,
