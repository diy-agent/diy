"""Panel IntRangeSlider — pn.widgets.IntRangeSlider 的 diy.ui 包装。"""
...
class IntRangeSlider(UIComponent, pn.widgets.IntRangeSlider):
    ...
    def __init__(
        ...
        *,
        ...
        self.diy.signal: diy.ui.Signal[tuple[int, int]] = diy.ui.Signal[tuple[int, int]](value)
        _label = label or name
        self.diy.init_done: bool = False
        pn.widgets.IntRangeSlider.__init__(
            self,
            label=_label,
            value=value,
            align=align,
