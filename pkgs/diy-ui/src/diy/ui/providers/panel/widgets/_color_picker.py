...
class ColorPicker(UIComponent, pn.widgets.ColorPicker):
    ...
    def __init__(
        ...
        *,
        ...
        self.diy.signal: diy.ui.Signal[str | None] = diy.ui.Signal[str | None](value)
        self.diy.init_done: bool = False
        pn.widgets.ColorPicker.__init__(
            self,
            label=_label,
            value=value,
            align=align,
